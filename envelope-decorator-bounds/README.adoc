...
image:envelope-decorator-bounds/bpmn-envelope-decorator-bounds.part.png["Envelope Decorator freely positioned along the Message Flow", link=envelope-decorator-bounds/bpmn-envelope-decorator-bounds.png]
